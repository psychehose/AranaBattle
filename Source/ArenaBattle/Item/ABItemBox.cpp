...
void AABItemBox::PostInitializeComponents()
{
	...
	UE_LOG(LogTemp, Log, TEXT("Number: %d"),Assets.Num());
	
	ensure(0 < Assets.Num());

	int32 RandomBox = FMath::RandRange(0, Assets.Num() - 1);
	FSoftObjectPtr AssetPtr(Manager.GetPrimaryAssetPath(Assets[RandomBox]));
